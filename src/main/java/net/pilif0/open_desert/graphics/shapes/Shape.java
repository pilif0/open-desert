...
public class Shape extends AbstractShape{
    ...
    static{
        ...
        try {
            ...
            throw new RuntimeException("Shape XPath compilation failed");
        }
    }
    ...
    public static Shape parse(Path p){
        ...
        try{
            ...
            vertices = new Vertex[idNodes.getLength()];
